...
const CloseDateUpsert = ({
  ...
  return (
    <div style={{ maxWidth: '800px' }}>
      ...
      <SuccessPopUpModal
        title={'Success!'}
        message={'Close Date created.'}
        modalPopUp={successModal}
        setModalPopUp={setSuccessModal}
        showActionBtns={true}
        showDayPopup={showCloseDayPopup}
        setShowDayPopup={setShowCloseDayPopup}
      />
      <CancelModalPopUp
        title="Confirmation"
