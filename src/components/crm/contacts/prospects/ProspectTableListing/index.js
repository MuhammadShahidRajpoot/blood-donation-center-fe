                      ...
                      .map((header, index) => (
                        <td key={`${rowData.id}-${index}`}>
                          {header.name === 'name' ? (
                            ...
                            <div>{rowData[header.name]?.city}</div>
                          ) : header.name === 'state' ? (
                            <div>{rowData['address']?.state}</div>
                          ) : header.name === 'primary_phone' ? (
                            <div className="phone">
                              {rowData['created_by']?.mobile_number}
                            </div>
                          ) : header.name === 'primary_email' ? (
                            <div className="phone">
                              {rowData['created_by']?.email}
                            </div>
                          ) : (
